          ...
          <div className="lg:col-span-5">
            ...
            <motion.div variants={itemVariants} className="mb-8">
              <p className="text-white/90 text-sm md:text-base leading-relaxed font-light">
                ZOSKALES is a jewelry company dedicated to crafting timeless pieces that embody elegance, sophistication, and personal expression. With a passion for fine craftsmanship, we transform precious metals, diamonds, and rare gemstones into meaningful designs.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-3 mb-8">
              <div className="flex items-center gap-3 text-white/80 hover:text-white transition-colors group">
                ...
                <span className="text-sm">info@zoskales.com</span>
              </div>
              <div className="flex items-center gap-3 text-white/80 hover:text-white transition-colors group">
                <div className="w-9 h-9 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center group-hover:bg-white/20 transition-all">

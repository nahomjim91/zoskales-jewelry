...
export function CraftingJewelry({ onMoreProductsClick }) {
  return (
    <div className="flex flex-col md:flex-row items-center  gap-1 px-6 md:px-12 lg:px-20 py-16">
...
>
  ...
  <div className="flex flex-col pt-10 gap-3">
    ...
    >
      <img
        src={"/images/Ear with Blue Earrings and Diamond Necklace - Brown Skin.png"}
        alt="Jewelry"
        className="w-full h-full object-cover"
      />
    </motion.div>

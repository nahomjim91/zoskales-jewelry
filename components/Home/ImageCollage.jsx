...
export default function ImageCollage({ onFollowClick }) {
 ...
 const images = [
    ...
    "/images/model_poster/This 💍ring isn’t just a piece of jewelry; it’s a promise, a forever, a sparkle crafted by 💎 Zo.jpg",
    ...
    "/images/model_poster/💎Inspired by nature, perfected by Zoskales Diamonds. Carry a piece of nature’s beauty, framed i (1).jpg",
  ];
